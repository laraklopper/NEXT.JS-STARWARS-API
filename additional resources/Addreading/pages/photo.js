...
export default class extends Component {
    /* Amongst other information getInitialProps has access to the query string, 
    hence we pass the as {query}, from which we get the id that comes from the index page. 
    Then we just find the image object that has the same id and pass it as the component props. */
    ...
    /*
    Exactly as we did in the Index component, the data is fetched and injected in the component state. 
    The returned JSX (react's version of HTML) is exactly the same just that we return from this.state. 
    Also ref is added to the form inputs. ("Refs provide a way to access DOM nodes or React elements created in the render method")*/
    componentWillMount() {
        this.setState({
